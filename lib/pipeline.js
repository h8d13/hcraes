...
import { gitlab, gitlabArch, gitlabAlpine } from "../sources/gitlab.js";
import { stackexchange } from "../sources/stack.js";
import { rrf } from "./fusion.js";
import { InvertedIndex, bm25Search } from "./bm25.js";

export const SOURCES = [wikipedia, hackerNews, github, gitlab, gitlabArch, gitlabAlpine, stackexchange];
...
function localRerank(query, fused) {
  ...
  const ranked = bm25Search(idx, query, fused.length);
